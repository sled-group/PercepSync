// Copied from https://github.com/microsoft/psi/blob/ef4b2a627ffefc5415b826930a883b309c0a37cd/Sources/MixedReality/HoloLensCapture/HoloLensCaptureInterop/Serializers.cs
namespace HoloLensCaptureInterop
{
    ...
    public static class Serializers
    {
        ...
        public static void WriteSceneObjectCollection(
            ...
            void WriteSceneObject(SceneObjectCollection.SceneObject obj)
            {
                ...
                if (obj != null)
                {
                    ...
                    WriteCollection(
                        ...
                        writer,
                        rect => WriteNullable(rect, writer, r => WriteRectangle3D(r, writer))
                    );
                }
                else
                {
        ...
        public static SceneObjectCollection ReadSceneObjectCollection(BinaryReader reader)
        {
            SceneObjectCollection.SceneObject ReadSceneObject()
            {
                ...
                var placementRectangles = ReadCollection(
                        reader,
                        () => ReadNullable(reader, () => ReadRectangle3D(reader))
                    )
                    .ToList();

                return new SceneObjectCollection.SceneObject(
                    meshes,
                    colliderMeshes,
                    rectangles,
                    placementRectangles
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteCoordinateSystem(
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteCoordinateSystemVelocity3D(
            CoordinateSystemVelocity3D coordinateSystemVelocity3D,
            BinaryWriter writer
        )
        {
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteAngularVelocity3D(
        ...
        public static AngularVelocity3D ReadAngularVelocity3D(BinaryReader reader)
        {
            ...
            if (hasOriginRotation)
            {
                ...
                originRotation = Matrix<double>.Build.DenseOfArray(
                    new double[,]
                    {
                        { or[0], or[3], or[6] },
                        { or[1], or[4], or[7] },
            ...
            return hasOriginRotation
                ? new AngularVelocity3D(originRotation, axisDirection, magnitude)
                : default;
        }
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteLinearVelocity3D(
            LinearVelocity3D linearVelocity3D,
            BinaryWriter writer
        )
        {
            // Write the origin rotation
        ...
        public static Format<Ray3D> Ray3DFormat() => new(WriteRay3D, ReadRay3D);
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteCalibrationPointsMap(
            CalibrationPointsMap calibrationPointsMap,
            BinaryWriter writer
        )
        {
            ...
            WriteCollection(
                calibrationPointsMap.CameraUnitPlanePoints,
                writer,
                f => writer.Write(f)
            );
        }
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteStereoKitHands(
            (StereoKitHand Left, StereoKitHand Right) hands,
            BinaryWriter writer
        )
        {
        ...
        public static (StereoKitHand Left, StereoKitHand Right) ReadStereoKitHands(
            BinaryReader reader
        )
        {
        ...
        public static Format<OpenXRHand> OpenXRHandFormat() => new(WriteOpenXRHand, ReadOpenXRHand);
        ...
        public static Format<WinRTEyes> WinRTEyesFormat() => new(WriteWinRTEyes, ReadWinRTEyes);
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteOpenXRHands(
            (OpenXRHand Left, OpenXRHand Right) hands,
            BinaryWriter writer
        )
        {
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteCameraIntrinsics(
            ...
            static void WriteVector(Vector<double> vector, int size, BinaryWriter writer)
            {
                if (vector.Count != size)
                {
                    throw new ArgumentException(
                        $"Expected vector of size {size} (actual: {vector.Count}."
                    );
                }
        ...
        public static Format<EncodedImageCameraView> EncodedImageCameraViewFormat() =>
            new(
                WriteEncodedImageCameraView,
                (reader, payload, _, _) => ReadEncodedImageCameraView(reader, payload)
            );
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteEncodedImageCameraView(
            EncodedImageCameraView encodedImageCameraView,
            BinaryWriter writer
        )
        {
        ...
        public static EncodedImageCameraView ReadEncodedImageCameraView(
            BinaryReader reader,
            byte[] payload
        )
        {
        ...
        public static Format<DepthImageCameraView> DepthImageCameraViewFormat() =>
            new(
                WriteDepthImageCameraView,
                (reader, payload, _, _) => ReadDepthImageCameraView(reader, payload)
            );
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteDepthImageCameraView(
            DepthImageCameraView depthImageCameraView,
            BinaryWriter writer
        )
        {
        ...
        public static DepthImageCameraView ReadDepthImageCameraView(
            BinaryReader reader,
            byte[] payload
        )
        {
        ...
        public static Shared<DepthImage> ReadDepthImage(BinaryReader reader, byte[] payload)
        {
            ...
            var image = DepthImagePool.GetOrCreate(
                width,
                height,
                depthValueSemantics,
        ...
        public static Format<ImageCameraView> ImageCameraViewFormat() =>
            new(
                WriteImageCameraView,
                (reader, payload, _, _) => ReadImageCameraView(reader, payload)
            );
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteImageCameraView(
            ImageCameraView imageCameraView,
            BinaryWriter writer
        )
        {
        ...
        {
            return new((value, writer) => writer.Write(value), (reader) => reader.ReadInt32());
        }
                ...
                (pipelineDiagnostics, writer) =>
                {
                    ...
                    void WriteEmitterDiagnostics(EmitterDiagnostics emitterDiagnostics)
                    {
                        ...
                        if (!knownEmitterIds.Contains(emitterDiagnostics.Id))
                        {
                            ...
                            WriteCollection(
                                emitterDiagnostics.Targets,
                                writer,
                                WriteReceiverDiagnostics
                            );
                        }
                    }
                    ...
                    void WritePipelineElementDiagnostics(
                        PipelineElementDiagnostics pipelineElementDiagnostics
                    )
                    {
                        ...
                        if (!knownPipelineElementIds.Contains(pipelineElementDiagnostics.Id))
                        {
                            ...
                            WriteCollection(
                                pipelineElementDiagnostics.Emitters,
                                writer,
                                WriteEmitterDiagnostics
                            );
                            WriteCollection(
                                pipelineElementDiagnostics.Receivers,
                                writer,
                                WriteReceiverDiagnostics
                            );
                            WritePipelineDiagnostics(
                                pipelineElementDiagnostics.RepresentsSubpipeline
                            );
                            WritePipelineElementDiagnostics(
                    ...
                    void WritePipelineDiagnostics(PipelineDiagnostics diagnostics)
                    {
                        ...
                        if (!knownPipelineIds.Contains(diagnostics.Id))
                        {
                            ...
                            WriteCollection(
                                diagnostics.SubpipelineDiagnostics,
                                writer,
                                WritePipelineDiagnostics
                            );
                            WriteCollection(
                                diagnostics.PipelineElements,
                                writer,
                                WritePipelineElementDiagnostics
                            );
                        }
                ...
                (reader) =>
                {
                    ...
                    PipelineElementDiagnostics ReadPipelineElementDiagnostics()
                    {
                        ...
                        pipelineElement = new PipelineElementDiagnostics(
                            ...
                            null
                        ); // connectorBridgeToPipelineElement
                        knownPipelineElements.Add(id, pipelineElement);

                        // recurse and complete assignment of instance fields
                        pipelineElement.Emitters = ReadCollection(reader, ReadEmitterDiagnostics)
                            .ToArray();
                        pipelineElement.Receivers = ReadCollection(reader, ReadReceiverDiagnostics)
                            .ToArray();
                        pipelineElement.RepresentsSubpipeline = ReadPipelineDiagnostics();
                        pipelineElement.ConnectorBridgeToPipelineElement =
                            ReadPipelineElementDiagnostics();
                    ...
                    PipelineDiagnostics ReadPipelineDiagnostics()
                    {
                        ...
                        pipeline.SubpipelineDiagnostics = ReadCollection(
                                reader,
                                ReadPipelineDiagnostics
                            )
                            .ToArray();
                        pipeline.PipelineElements = ReadCollection(
                                reader,
                                ReadPipelineElementDiagnostics
                            )
                            .ToArray();
        ...
        public static Format<DateTime> DateTimeFormat() => new(WriteDateTime, ReadDateTime);
        ...
        public static Format<Color> ColorFormat() => new(WriteColor, ReadColor);
        ...
        public static Color ReadColor(BinaryReader reader) => Color.FromArgb(reader.ReadInt32());
        ...
        /// <param name="writer"><see cref="BinaryWriter"/> to which to write.</param>
        public static void WriteImu(
            (Vector3D Value, DateTime OriginatingTime)[] imu,
            BinaryWriter writer
        )
        {
            WriteCollection(
        ...
        public static Format<bool> BoolFormat() => new(WriteBool, ReadBool);
        ...
        public static Format<Guid> GuidFormat() => new(WriteGuid, ReadGuid);
        ...
        public static Guid ReadGuid(BinaryReader reader) => Guid.Parse(ReadString(reader));
        ...
        public static Format<Box3D> Box3DFormat() => new(WriteBox3D, ReadBox3D);
        ...
        public static Format<Bounds3D> Bounds3DFormat() => new(WriteBounds3D, ReadBounds3D);
        ...
        public static Format<string> StringFormat() => new(WriteString, ReadString);
        ...
        public static void WriteNullable<T>(
            T? value,
            BinaryWriter writer,
            Action<T, BinaryWriter> writeAction
        )
            where T : struct => WriteNullable(value, writer, v => writeAction(v, writer));
        ...
        public static T? ReadNullable<T>(BinaryReader reader, Func<BinaryReader, T> readFunc)
            where T : struct => ReadNullable(reader, () => readFunc(reader));
        ...
        public static void WriteDictionary<TKey, TValue>(
            ...
            WriteDictionary(
                dictionary,
                writer,
                d => writeKeyAction(d, writer),
                d => writeValueAction(d, writer)
            );
